...
def get_wta_single_tournaments():
    ...
    v2 = ['https://www.tennis24.com/wta-singles/guadalajara-2/',
    ...
    v5 = ['https://www.tennis24.com/wta-singles/ostrava/', 'https://www.tennis24.com/wta-singles/palermo/',
...
def iterate_tournament(driver: webdriver.Chrome):
    ...
    for link in links:
        ...
        for index, match_link in enumerate(match_links):
            ...
            if link.strip() == 'https://www.tennis24.com/wta-singles/guadalajara-2/' and index < 29:
