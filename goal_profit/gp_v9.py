    ...
    while True:
        ...
        try:
            ...
            if 'login' in driver.current_url:
                ...
                logging.info("--> game extraction started ...")

                while True:
                    time.sleep(2)
                    live_games_button = driver.find_element(By.XPATH, '//li[@data-id="2"]')
                    driver.execute_script("arguments[0].click();", live_games_button)
                    try:
                        WebDriverWait(driver, 4).until(
                            EC.visibility_of_element_located((By.XPATH, '//li[@data-id="2"]')))
                        break
                    except:
                        continue
            ...
            try:
                WebDriverWait(driver, 4).until(
                    EC.visibility_of_element_located((By.XPATH, '//div[@id="html2"]//table')))
            except:
                continue
