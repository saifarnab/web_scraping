...
def login(driver):
    driver.get('https://www.superpharmacy.com.au/')
    driver.find_element(By.XPATH, "//a[@title='Login to your account']").click()
    time.sleep(3)
    driver.find_element(By.ID, 'username').send_keys('saifornab@gmail.com')
    driver.find_element(By.ID, 'password').send_keys('232889')
    driver.find_element(By.CSS_SELECTOR, '.primary-button.g-recaptcha').click()
    time.sleep(120)
...
def scrapper():
    file_name = 'data_shopify_exp2.csv'
    exp_file_name = 'exp_new2.csv'
